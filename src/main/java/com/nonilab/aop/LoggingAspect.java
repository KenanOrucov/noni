...
import static com.nonilab.mapper.ObjectMapperFactory.OBJECT_MAPPER;

@Slf4j
@Aspect
@Component
public class LoggingAspect {
    @Around("within(@com.nonilab.aop.annotation.Log *) && !@annotation(com.nonilab.aop.annotation.LogIgnore)")
